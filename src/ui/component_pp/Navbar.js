...
import { DragDropContext, Droppable, Draggable as BDrag } from "react-beautiful-dnd";
...
class NavigationBar extends React.Component {
  ...
  fetchContent(type,item)
  {
    ...
    else if(type=== 'contentBox')
    {
      ...
      return <div onClick={()=>this.setState({selectedId:b.id})} className = "d-flex align-items-center" style={{"width":"284px", position:"absolute", 'zIndex':this.state.selectedId == b.id ? 2 :1}}>
  ...
  render() {
    return (
      ...
      >
        {this.display(snapshot)}
        <div style={{height: '95vh', width: '100%', position: 'absolute', overflow: 'auto', padding: '0'}}>
